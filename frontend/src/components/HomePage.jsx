  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-slate-800 text-white p-6">
      ...
      <div className="text-center max-w-2xl">
        <h1 className="text-4xl font-bold mb-4">Your Personal Mental Health Companion</h1>
      ...
      <div className="mt-16 w-full max-w-6xl px-6">
        <h2 className="text-3xl font-semibold text-center mb-8">Explore Our Features</h2>
            ...
            <div className="flex items-center space-x-4">
              <div className="bg-blue-500 p-3 rounded-full">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M21 12.75A9 9 0 1112 3a9 9 0 019 9.75z"></path>
                </svg>
              </div>
          ...
          <div className="bg-slate-900 p-6 rounded-lg shadow-lg hover:shadow-xl transition">
            <div className="flex items-center space-x-4">
              <div className="bg-green-500 p-3 rounded-full">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 19V6l-2 2m0 0l-2-2m2 2v10m6 0v-4a2 2 0 012-2h4a2 2 0 012 2v4m-2-4v4m0 0h-4"></path>
                </svg>
              </div>
